...
function detectRepair(question) {
  ...
  return {
    ...
    hrFriendly: /like i am hr|hr friendly|like hr|non[- ]?tech(?:nical)?|not a tech person|not tech savvy|explain in simple terms|dumb it down|explain like i'?m (?:five|new|non[- ]?tech(?:nical)?)/.test(q),
