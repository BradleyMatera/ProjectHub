...
function buildRawPacket({ question, agentName }) {
  // Raw packet intentionally uses a minimal persona to stay under the comparison token budget.
  const personaLine = `You are ${getAssistantName() || agentName || 'Scout'}, a recruiter assistant.`;
