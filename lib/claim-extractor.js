...
function buildRelationPatterns() {
  ...
  { re: /\bbeing\s+(?:a|an)\s+([a-z][a-z0-9+#.'\s-]{1,40}?)(?=\s*(?:[.;!?,]|\s+(?:and|but|or|who|which|that|because|since|while|when|if|as|so|in|at|on|for|with|by|to|of|from)\b|$))/i, relation: 'is_type', type: 'FACT' },
