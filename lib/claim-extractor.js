...
const { EXPERTISE_RELATIONS } = require('./relationship-graph');
  ...
  for (let sIdx = 0; sIdx < sentences.length; sIdx++) {
    ...
    for (const pattern of RELATION_PATTERNS) {
      ...
      if (pattern.relation === 'uses_tech') {
        ...
        if (new RegExp('^(?:he|she|they' + subjectAlt + ')$', 'i').test(s)) {
          subject = 'subject';
        ...
        if (subject !== 'subject' && _subjectNameParts.size > 0) {
          ...
          if ([..._subjectNameParts].some(part => subjWords.has(part))) subject = 'subject';
        }
        object = o;
        ...
        if (subject && new RegExp('^(?:he|she|they' + subjectAlt + ')$', 'i').test(subject)) subject = 'subject';
        ...
        if (match[1] && match[2]) {
          ...
          if (new RegExp('^(?:he|she|they|it' + subjectAlt + ')$', 'i').test(s)) {
            subject = 'subject';
          } else if (/^[A-Z]/.test(s)) {
            subject = s;
