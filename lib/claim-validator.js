...
function validateProjectTechnologyRelationships(text, contract, knowledge, evidenceText = '') {
  ...
  const graphTech = buildRelationshipGraph(knowledge).triples.filter(triple =>
 ...
 */
function validateClaims(answer, question, contract, evidenceText, knowledge, evidence = null) {
  ...
  invalid.push(...validateProjectTechnologyRelationships(text, contract, knowledge,
    Array.isArray(evidence) && evidence.length ? evidence : evidenceText));
