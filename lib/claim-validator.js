...
function validateProjectTechnologyRelationships(text, contract, knowledge, evidenceText = '') {
  ...
  const CLAUSE_BOUNDARY = /\s*[:;]\s+|(?:,?\s*(?:and|but|or|nor|yet|so)\s+(?=(?:it|he|she|they|there|the|a|an|this|that|which|who|what|was|were|is|are|has|had|have|does|did|do|will|would|could|should)\b))/i;
