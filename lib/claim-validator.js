...
function validateClaims(answer, question, contract, evidenceText, knowledge) {
  ...
  if (policyMode === 'META' || /\b(?:your\s+name|who\s+are\s+you|what\s+are\s+you|are\s+you)\b/i.test(q)) {
