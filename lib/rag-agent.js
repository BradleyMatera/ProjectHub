...
async function runRagPrimaryAgent({ question, conversationState, evidence, knowledge, sessionId, model, policyContract, deadlineAt, abortSignal }) {
  ...
  // Previous direct-knowledge-bypass paths for PROFILE_SUMMARY, STRENGTH_EVIDENCE,
  // RECRUITER_RECOMMENDATION, EXPERIENCE, PROJECT_DETAILS, and YES_NO have been
  // removed. The generic generative engine now produces these responses from the
  // evidence, guardrails, and response contract.
