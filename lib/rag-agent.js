...
function buildGuardrails(responseContract, policyContract, question, knowledge) {
  ...
  if (responseContract?.subIntent === 'EXPERIENCE') {
    rails.push('This asks about real-world experience. Use only the experience and project facts. State the actual role, scope, and evidence level (training, internship, or professional). Do not invent seniority, production ownership, or live customer-ticket work.');
  }
