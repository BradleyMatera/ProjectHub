...
function buildGuardrails(responseContract, policyContract, question, knowledge) {
  ...
  if (responseContract?.subIntent === 'PROFILE_SUMMARY') {
    rails.push('This is a profile summary. Use the subject\'s exact title and location from the identity fact. Do not replace the title with generic words like "person" or "candidate". Draw only from identity, pitch, summary, what-he-does, and target-role facts. Do NOT mention any specific technology, programming language, framework, tool, cloud service, or skill by name (e.g., Python, AWS, Docker, JavaScript, HTML, CSS, React, Git, GitHub, Cloudflare, Go, Rust). Keep the answer to the person\'s title, location, and high-level professional focus.');
  }
