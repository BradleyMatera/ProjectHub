...
const RAG_NUM_PREDICT = parseInt(process.env.SCOUT_RAG_NUM_PREDICT || '140', 10);
...
function buildRagPrimaryPacket({ question, ragEvidence, enrichment, guardrails, conversationState, maxTokens }) {
  ...
  const systemLines = [
    ...
    'You may synthesize information across multiple evidence items.',
    ...
    'Keep answers concise: 1-2 complete sentences unless the question clearly asks for more.',
