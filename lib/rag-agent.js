...
function buildRagEvidenceText(evidence, maxChars = RAG_EVIDENCE_MAX_CHARS, maxItems = RAG_EVIDENCE_MAX_ITEMS, intent = null) {
  ...
  const intentBoosts = {
    ...
    PROFILE: { identity: 1.4, pitch: 1.4, summary: 1.4, 'what-he-does': 1.3, 'looking-for': 1.2, 'target-roles': 1.2, education: 1.3, experience: 1.3, certification: 1.3, 'scout-runtime': 0.6 },
