...
function buildRagPrimaryPacket({ question, ragEvidence, enrichment, guardrails, conversationState, maxTokens }) {
  ...
  const systemLines = [
    ...
    'EXAMPLE:\nEVIDENCE: FACT 1 [identity] The Subject is an example-role based in Example City, State. FACT 2 [pitch] The Subject has a background in web development, cloud support training, and troubleshooting.\nQ: Tell me about the subject.\nA: {"answer": "The Subject is an example-role based in Example City, State. Their background is in web development, cloud support training, and troubleshooting."}',
