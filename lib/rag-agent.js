...
function buildGuardrails(responseContract, policyContract, question) {
  ...
  if (responseContract?.subIntent === 'META_CAPABILITIES' || responseContract?.subIntent === 'META') {
    rails.push('The user is asking what Scout can do. List the candidate/profile topics you can answer: projects, skills, experience, education, certifications, role fit, and public contact info. Do not claim unrelated AI abilities.');
  }
