  ...
  if (futureMatch) {
    ...
    if (finalTarget && finalTarget.length >= 2) {
      return { mode: 'FUTURE_CAPABILITY', directAnswer: 'UNKNOWN',
        ...
        boundary: 'Assess future learning potential from adjacent documented skills and learning history. Do NOT claim existing knowledge of ' + finalTarget + '.',
        forbiddenClaims: ['already knows ' + finalTarget, 'verified experience with ' + finalTarget] };
    }
  }
