...
function validateNegativeAssessment(testCase, result, opts) {
  ...
  const explicitWeakness = /\b(?:(?:he|she|the subject) is (?:bad|weak|terrible) at|(?:they) are (?:bad|weak|terrible) at|(?:his|her|their|the subject's) weakness is|(?:he|she|the subject) (?:struggles) with|(?:they) (?:struggle) with|(?:he|she|the subject) is terrible at|poor at|bad at)\b/i;
