...
const TECH_CLAIM_CONTEXTS = [
  ...
  /\b(?:knows?|has\s+experience\s+(?:with|in|at)|proficient\s+in|skilled\s+in|familiar\s+with|expertise\s+in)\s+([A-Za-z][A-Za-z0-9+#.\s-]{1,40}?)(?:\s+(?:for|as|in|on|to|and|;)|(?:,|\.(?:\s|$))|$)/gi,
