...
// Technology names may be valid query subjects even when Bradley's verified
...
const QUERY_EXPANSIONS = [
  { re: /\btech stack\b/i, terms: 'skills languages frameworks databases tools javascript react node' },
