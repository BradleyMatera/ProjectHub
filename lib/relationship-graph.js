    ...
    for (const gap of k.summary.honestGaps) {
      if (typeof gap === 'string' && gap.trim()) {
        ...
        if (gapName) {
          ...
          // Extract parenthetical abbreviations (e.g., "Data structures and algorithms (DSA)")
          // and short leading noun phrases as aliases so "DSA" and the full name
          // resolve to the same gap.
