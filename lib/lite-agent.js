...
function buildLitePacket({ question, compressedEvidence, operation, maxTokens }) {
  ...
  const system = [
    ...
    'NEVER say "I", "my", "me", "my work", "my experience", "my projects".',
    'ALWAYS say "he", "his", "him", "his work", "his experience", "his projects".',
    'Example: Q: "Does he know DynamoDB?" A: "Yes. His AWS internship capstone used DynamoDB as part of a serverless metadata workflow with Lambda, S3, and CloudFront."',
    'Example: Q: "Was he senior?" A: "No. He was an intern, not senior."',
    '',
    `FACTS:`,
    truncate(compressedEvidence, systemBudget - 400)
  ].join('\n');
