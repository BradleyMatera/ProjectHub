...
const REPAIR_HINTS = {
  ...
  negative_personal: 'Do not assert a specific personal-weakness phrase (e.g. "struggles with", "bad at", "his weakness is"). State that no verified personal weakness is documented, then name the documented learning/gap area as a neutral learning area.',
