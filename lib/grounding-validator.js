...
function validateAnswer(answer, source, question = '', knowledge = null, history = [], graph = null) {
  ...
  if (knowledge) {
    try {
      ...
      // 8c1e. "[Company] was part of his internship/work/experience" — implies employment
      // Example: "Netflix was part of his internship."
      const companyAsPartPattern = /\b([A-Z][A-Za-z0-9&.\s-]{2,40}?)\s+(?:was|is)\s+part\s+of\s+(?:his|her|their)\s+(?:internship|work|experience|career|job|role)/g;
