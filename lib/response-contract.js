  ...
  if (subIntent === 'NEGATIVE_ASSESSMENT') {
    ...
    if (factState === 'TRUE') {
      ...
      if (asksBadAt) {
        ...
        instructions.push('Use neutral, fact-based wording. Do NOT write "struggle", "struggles", "struggling", "struggled", "difficulty", "difficult", "weakness", "weak", "bad at", "poor at", "weak at", "terrible at", or any similar negative-trait phrase when describing the documented gap/learning area. Example allowed phrasing: "A documented learning area is data structures and algorithms (DSA), where the profile notes Udemy courses and math discussions but no production mentorship or formal CS degree."');
      }
    }
  }
