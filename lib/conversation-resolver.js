...
function extractEntitiesFromText(text, knowledge, options = {}) {
  ...
  // This lets "Bradley worked at Google, right?" → follow-up "there" resolve to
  // Google instead of bleeding into the visitor's name or other referents.
...
// "Bradley's X", "its X", "the company's X") is a FACET follow-up about the
