    ...
    case 'COMPARISON':
      ...
      // Check that both entities from the question are mentioned in the answer
      {
        ...
        if (compareMatch) {
          ...
          // Check if both entities (or their first word) appear in the answer
          const hasEntity1 = answerLower.includes(entity1) || answerLower.includes(entity1.replace(/[^a-z0-9]/g, ''));
          const hasEntity2 = answerLower.includes(entity2) || answerLower.includes(entity2.replace(/[^a-z0-9]/g, ''));
